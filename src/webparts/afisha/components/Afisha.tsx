...
export default class Afisha extends React.Component<IAfishaProps, {}> {
  ...
  private kinopoisk() {
    ...
    console.log(date);
    let uri = `https://api.themoviedb.org/3/discover/movie?primary_release_date.gte=${date}&primary_release_date.lte=${date}`;
  ...
  private addRecord(item,userName){
    console.log('rab');
    let wep = new Web('https://cupcuper.sharepoint.com/sites/dev1');
    wep.lists.getById('a5558fa4-8101-4bd8-b487-d9cadfef789d').items.add({
      Title: item.title,
      EndDate: item.date,
      EventDate: item.date,
      UserName: userName
        ...
        <div className={styles.container}>
          <div className={styles.row}>
            <div className={styles.column}>
              ...
              <Covers
                events={this.state.events.slice(0, 3)}
